...
public class Process {
    ...
    public void process(Renderable renderable){
        ...
        GLES20.glVertexAttribPointer(attribPosition, 3, GLES20.GL_FLOAT, false, 0, 0);
        GLES20.glVertexAttribPointer(attribTextureCoordinate, 4, GLES20.GL_FLOAT, false, 0, 0);
